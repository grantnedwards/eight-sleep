...
class EightSleepAPIExplorer:
    ...
    async def explore_api(self) -> None:
        """Explore all available API endpoints"""
        logger.info("Starting comprehensive API exploration...")
        
        # Step 1: Get user profile and device information
        await self._explore_user_profile()
        
        # Step 2: Explore device data
        await self._explore_device_data()
        
        # Step 3: Explore user-specific data
...
async def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python safe_api_explorer.py <email> <password>")
        sys.exit(1)
